...
const sideImages = [
  {
    src: "/images/tech-workers.jpg",
    alt: "Farm workers sorting fresh produce",
    position: "left",
    span: 1,
  },
  {
    src: "/images/tech-produce-closeup.jpg",
    alt: "Close-up of fresh Indian produce",
    position: "left",
    span: 1,
  },
  {
    src: "/images/tech-quality-process.jpg",
    alt: "Quality control process in facility",
    position: "right",
    span: 1,
  },
  {
    src: "/images/tech-export-packing.jpg",
...
export function TechnologySection() {
  ...
  const descriptionText = "RafRaf International brings the freshest Indian produce to UAE markets through direct farmer partnerships and modern cold chain infrastructure. Every shipment is quality-tested, properly packaged, and delivered with precision timing to ensure your business receives premium products that meet international standards.";
            ...
            >
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["From Farm", "to Table.", "Trusted."].map((word, index) => {
